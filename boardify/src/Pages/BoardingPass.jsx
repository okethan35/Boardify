        ...
        <div className="boarding-pass-container">
          <div className={`boarding-pass`}>
            ...
            <div className="header">
              {(
                <img
                  src={userData.profile.profileURL || "data:image/png;base64,"}
                  alt="Profile"
                  className="profile-picture"
                />
              )}
            ...
            <div className="Board">
              ...
              <div className="details">
                ...
                <div className="details-container">
                  ...
                  <div>
                    <strong>Date:</strong> <span>{`${String((new Date()).getDate()).padStart(2, '0')}/${String((new Date()).getMonth() + 1).padStart(2, '0')}/${(new Date()).getFullYear()}`}</span>
                  </div>
                </div>
