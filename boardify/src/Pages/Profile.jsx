...
const Profile = () => {
  ...
  const renderContent = () => {
    if (!isLoggedIn) {
      return ( //viewing profile for users not logged into the website
        <>
          <img
    ...
    if (!isSpotifyConnected & username == localStorage.getItem("username")) {
      return ( //viewing your own profile when not connected to spotify
        <>
          <img
            src="data:image/png;base64,"
            alt="Default Profile"
    ...
    if (!isSpotifyConnected & username != localStorage.getItem("username")) {
      return ( //viewing other user's profile when they are not connected to spotify
        <>
          <h2>Welcome to {username}{username.endsWith("s") ? "'" : "'s"} Profile</h2>
          <img
            src="data:image/png;base64,"
            alt="Default Profile"
            className="profile-picture default"
    ...
    if (localStorage.getItem("username") === username) {
      ...
      welcomeMessage = `Welcome to ${username}${username.endsWith("s") ? "'" : "'s"} Profile`;
    }

    return ( //viewing profile connected to spotify
      <>
